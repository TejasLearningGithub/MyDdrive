...
void main() {
  /// 1.1 init ZIMKit
  ZIMKit().init(
    appID: 1504440203, // your appid
    appSign:
        'eb833fea333b812e3a8c825f144cfc8d34511a28fb54be78ec52d5a42c4689dd', // your appSign
  );
...
void onUserLogin(String id, String name) {
  ...
  ZegoUIKitPrebuiltCallInvitationService().init(
    appID: 1504440203 /*input your AppID*/,
    appSign:
        'eb833fea333b812e3a8c825f144cfc8d34511a28fb54be78ec52d5a42c4689dd' /*input your AppSign*/,
    userID: id,
    userName: name,
